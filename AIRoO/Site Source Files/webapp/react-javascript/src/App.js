    ...
    return (
      <div className="App">
        <img src={require("./images/banner_c.jpg")} />
          ...
          <span style={{display:"flex", justifyContent:"flex-end", width:"95%", padding:"20px"}}>
            <button type="button" className="btn  ml-lg-2 ls-btn" data-toggle="modal" aria-pressed="false" data-target="#exampleModal"> Login </button>
          </span>
          <div className="register py-4" id="register">
            <div className="container py-lg-5">
              <div className="row register-form py-md-5">
                <div className="col-lg-4 register-bottom d-flex flex-column register-right-ls">
                  <div className="title-wthree">
                    <h3 className="agile-title">register</h3>
                    <span></span>
                  </div>
                  <p className="font-weight-bold text-capitalize">become a member of
                    <span>AiRoO</span>
                    <p className="pb-sm-5">Example text.</p>
                  </p>
                </div>
                <div className="offset-lg-2"></div>
                <div className="col-lg-6 wthree-form-left py-sm-5">
                  <div className="register-top1">
                    <form action="connect.php" method="post">
                      ...
                      <div className="form-group">
                        <div className="row">
                          ...
                          <div className="col-md-10">
                            ...
                            <input type="password" className="form-control" placeholder="*******" name="Password" id="password2" required />
                          </div>
                        </div>
                      </div>
                      <div className="row mt-lg-5 mt-3">
                        ...
                        <div className="col-md-10">
                          <button type="submit" className="btn btn-agile btn-block w-100">register</button>
                        </div>
                      </div>
                    </form>
                  </div>
